...
For everything you ever wanted to know about running Wordpress on Heroku, check out mchung's [heroku-buildpack-wordpress](http://github.com/mchung/heroku-buildpack-wordpress).
